...
function _meetupId_MeetupDetails(props) {
  return (
    /*#__PURE__*/
    // <Fragment>
    Object(jsx_runtime_["jsx"])(meetups_MeetupDetails, {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://deepesh21100:Deepesh^123@cluster0.gz8qkso.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (_meetupId_MeetupDetails); // S;
